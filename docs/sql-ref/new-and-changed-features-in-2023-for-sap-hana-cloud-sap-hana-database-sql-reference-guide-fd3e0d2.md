...
SAP introduces new and changed features in the SAP HANA Cloud, SAP HANA Database SQL Reference Guide.
...
Heterogeneous Create/Alter Partition Clauses \(Changed\)

</b></dt>
<dd>

Table partitions now support dynamic aging. [Heterogeneous Create Partition Clauses](010-SQL-Reference/012-SQL-Statements/heterogeneous-create-partition-clauses-d496e58.md), [Heterogeneous Alter Partition Clauses](010-SQL-Reference/012-SQL-Statements/heterogeneous-alter-partition-clauses-a4258b8.md)
...
-   The DYNAMIC\_RANGE\_INTERVAL column has been added to the view to provide information on the interval and type of dynamically created partitions.
-   The DYNAMIC\_DISTANCE\_INTERVAL and DYNAMIC\_DISTANCE\_LOAD\_UNIT columns have been added to the view to support dynamic aging.
