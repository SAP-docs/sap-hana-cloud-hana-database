...
> ### Tip:  
> SAP Business Application Studio's *Guided Development* tool includes a tutorial called *Use Objects Contained in an External Database Schema* which shows you how to complete the individual steps in this task. You can find a link to the *Guided Development* tool on SAP Business Application Studio's *Welcome* screen or in the command palette \(*View* \> *Find Command...* \> *Guided Development*\).
...
9.  Bind the table-grantor service to your application project.
    ...
    In the *SAP HANA PROJECTS* tab, expand the project's *Database Connections* node, select the service to which you want to bind your application \(for example, ![](../20-HANA-Cloud-DB-Dev-Get-Started/images/BAS_icon_dependencyNotBound_1694e4a.svg) *EPM\_XXX-table-grantor*\), and choose ![](../20-HANA-Cloud-DB-Dev-Get-Started/images/BAS_icon_bind_074ce84.svg) \(*Bind*\).
